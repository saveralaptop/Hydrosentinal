        ...
        <section className="relative text-center py-20 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <motion.button
              ...
              whileHover={{
                scale: 1.1,
                boxShadow: "0px 0px 25px rgba(14,165,233,0.6)",
              }}
              whileTap={{ scale: 0.95 }}
              onClick={() => {
                document
              ...
              className="mt-6 px-6 py-3 rounded-xl bg-gradient-to-r from-sky-500 to-cyan-500 text-white font-semibold shadow-lg"
            >
              📍 Locations
            </motion.button>
